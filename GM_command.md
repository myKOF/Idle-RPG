...
- **場景**：支援場景編號（`1` 草原、`2` 荒漠、`3` 沼澤、`4` 亡靈山脈、`5` 太古戰場、`6` 混沌界、`7` 永恒神域）、英文 key 或中文名稱。若省略則預設為當前場景。
...
```text
stage_jump 1 50 （將最高關卡設為草原第 50 階，51 階以後及荒漠等後續地圖視為不可進）
stage 2 150 （將最高關卡設為荒漠第 150 階，草原全通關，151 階以後及沼澤等後續地圖鎖定）
stage 2/150 （斜線格式，指定荒漠第 150 階為最高關卡）
...
- **場景**：支援場景編號（`1` 草原、`2` 荒漠、`3` 沼澤、`4` 太古戰場、`5` 混沌界、`6` 永恒神域）、英文 key 或中文名稱。
...
```text
1/5/100 （連殺 1號場景草原 第 5 階怪物 100 隻，全裝備保留）
kill 1 500 100 mythic （連殺草原 第 500 階怪物 100 隻，篩選神話品質裝備）
kill 1 500 100 mythic weapon （連殺草原 第 500 階怪物 100 隻，篩選神話品質主武器）
kill 1 500 100 helmet （連殺草原 第 500 階怪物 100 隻，不限品質，只保留頭盔）
```
