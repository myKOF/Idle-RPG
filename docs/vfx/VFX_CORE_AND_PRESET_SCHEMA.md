...
刻意**不做**：子發射器、碰撞、trail renderer、以及 Unity 那套完整曲線編輯。
（原本這一行還包含「貼圖動畫」與「噪聲場」，兩者都已於 2026-09-06 補上，
見 §2.1.2 與 §2.2.1。）
...
⚠️ 2026-09-06 同日，噪聲場、徑向／環繞速度、阻力（§2.2.1）與序列幀（§2.1.2）
也都做了。清單上還沒做的只剩子發射器、trail 與扭曲；前兩者不需要新素材，
扭曲要先有可平鋪的噪聲貼圖（見 §7 Material Gap）。
