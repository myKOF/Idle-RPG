...
var AFFIX_POOL = {
  ...
  normalDmgRed: { name: '普通敵人傷害抗性', base: 15, lv: 0.8, pct: false, weight: 9, minR: 4, slots: ['shoulder', 'chest', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  eliteDmgRed: { name: '菁英傷害抗性', base: 15, lv: 0.8, pct: false, weight: 9, minR: 4, slots: ['shoulder', 'chest', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  bossDmgRed: { name: 'BOSS傷害抗性', base: 15, lv: 0.8, pct: false, weight: 9, minR: 4, slots: ['shoulder', 'chest', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  ...
  pRes: { name: '物理抗性%', base: 10, lv: 0.04, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  mRes: { name: '魔法抗性%', base: 10, lv: 0.04, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resFire: { name: '火焰抗性%', base: 20, lv: 0.1, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resIce: { name: '冰霜抗性%', base: 20, lv: 0.1, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resLightning: { name: '雷電抗性%', base: 20, lv: 0.1, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resPoison: { name: '劇毒抗性%', base: 20, lv: 0.1, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resLight: { name: '聖光抗性%', base: 20, lv: 0.1, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resDark: { name: '暗影抗性%', base: 20, lv: 0.1, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resAll: { name: '全屬性抗性%', base: 5, lv: 0.025, pct: true, weight: 3, minR: 4, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
...
var FIELD_DROP_TABLE = [// 野外：依怪物等級（掉落區間與裝備套裝等級分開）
  ...
  { min: 40, rates: [35, 20, 15, 5, 1.5, 0, 0, 0] },
