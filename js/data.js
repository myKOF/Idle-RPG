...
var FIELD_DROP_TABLE = [   // 野外：依怪物等級
  { min: 150, rates: [0, 0, 0, 10, 4, 2, 0.2, 0] },
  { min: 100, rates: [0, 10, 8, 6, 5, 1.5, 0, 0] },
  { min: 50,  rates: [10, 10, 5, 5, 0, 0, 0, 0] },
...
var STAT_GROUPS = [
  ...
  { title: '進攻屬性', rows: [
    ...
    ['💥 暴擊率', function (st) { return statFmt(st.critRate, STAT_CAPS.critRate, '%'); }, '攻擊時造成額外暴擊傷害的機率。' + capText(STAT_CAPS.critRate, '%')],
