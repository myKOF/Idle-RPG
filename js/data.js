...
var AFFIX_POOL = {
  ...
  hpFlat: { name: '生命值', base: 22, growthBase: 22, lv: 3, pct: false, weight: 11, slots: ['helmet', 'shoulder', 'chest', 'gloves', 'wrist', 'legs', 'boots', 'amulet'] },
  hpPct: { name: '生命值%', base: 5, growthBase: 5, lv: 0.02, pct: true, weight: 7, slots: ['helmet', 'shoulder', 'chest', 'gloves', 'wrist', 'legs', 'boots', 'amulet'] },
  hpRegen: { name: '生命恢復/秒', base: 2, growthBase: 2, lv: 0.5, pct: false, weight: 5, slots: ['helmet', 'shoulder', 'chest', 'gloves', 'wrist', 'legs', 'boots', 'amulet'] },
  ...
  mpRegen: { name: '法力恢復/秒', base: 0.8, growthBase: 0.8, lv: 0.06, pct: false, weight: 4, slots: ['helmet', 'shoulder', 'chest', 'gloves', 'wrist', 'legs', 'boots', 'amulet'] },
  ...
  normalDmgRed: { name: '普通敵人傷害抗性', base: 6, growthBase: 6, lv: 0.35, pct: false, weight: 9, minR: 4, slots: ['shoulder', 'chest', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  eliteDmgRed: { name: '菁英傷害抗性', base: 6, growthBase: 6, lv: 0.35, pct: false, weight: 9, minR: 4, slots: ['shoulder', 'chest', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  bossDmgRed: { name: 'BOSS傷害抗性', base: 6, growthBase: 6, lv: 0.35, pct: false, weight: 9, minR: 4, slots: ['shoulder', 'chest', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  aspd: { name: '攻擊速度%', base: 3, growthBase: 3, lv: 0.012, pct: true, weight: 6, slots: ['weapon', 'gloves', 'ring', 'amulet'] },
  critRate: { name: '暴擊率%', base: 2.5, growthBase: 2.5, lv: 0.012, pct: true, weight: 6, slots: ['weapon', 'belt', 'ring', 'amulet'] },
  critDmg: { name: '暴擊傷害%', base: 8, growthBase: 8, lv: 0.05, pct: true, weight: 5, slots: ['weapon', 'belt', 'ring', 'amulet'] },
  pPen: { name: '物理穿透%', base: 3, growthBase: 3, lv: 0.015, pct: true, weight: 4, minR: 4, slots: ['weapon', 'gloves', 'wrist', 'ring', 'amulet'] },
  mPen: { name: '魔法穿透%', base: 3, growthBase: 3, lv: 0.015, pct: true, weight: 4, minR: 4, slots: ['weapon', 'gloves', 'wrist', 'ring', 'amulet'] },
  hit: { name: '命中率%', base: 3, growthBase: 3, lv: 0.015, pct: true, weight: 5, slots: ['helmet', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  cdr: { name: '冷卻縮減%', base: 2.5, growthBase: 2.5, lv: 0.01, pct: true, weight: 4, minR: 4, slots: ['helmet', 'belt', 'gloves', 'ring', 'amulet'] },
  ...
  eliteDmg: { name: '對菁英傷害%', base: 4, growthBase: 4, lv: 0.02, pct: true, weight: 4, minR: 3, slots: ['weapon', 'helmet', 'shoulder', 'ring', 'amulet'] },
  bossDmg: { name: '對BOSS傷害%', base: 4, growthBase: 4, lv: 0.02, pct: true, weight: 4, minR: 3, slots: ['weapon', 'helmet', 'shoulder', 'ring', 'amulet'] },
  normalDmg: { name: '對普通敵人傷害%', base: 3, growthBase: 3, lv: 0.035, pct: true, weight: 9, minR: 3, slots: ['weapon', 'helmet', 'shoulder', 'ring', 'amulet'] },
  dmgVsFire: { name: '對火屬性敵人傷害%', base: 0.8, growthBase: 0.8, lv: 0.005, pct: true, weight: 3, minR: 3, slots: ['weapon', 'ring', 'amulet'] },
  dmgVsIce: { name: '對冰屬性敵人傷害%', base: 0.8, growthBase: 0.8, lv: 0.005, pct: true, weight: 3, minR: 3, slots: ['weapon', 'ring', 'amulet'] },
  dmgVsLightning: { name: '對雷屬性敵人傷害%', base: 0.8, growthBase: 0.8, lv: 0.005, pct: true, weight: 3, minR: 3, slots: ['weapon', 'ring', 'amulet'] },
  dmgVsPoison: { name: '對毒屬性敵人傷害%', base: 0.8, growthBase: 0.8, lv: 0.005, pct: true, weight: 3, minR: 3, slots: ['weapon', 'ring', 'amulet'] },
  dmgVsLight: { name: '對聖屬性敵人傷害%', base: 0.8, growthBase: 0.8, lv: 0.005, pct: true, weight: 3, minR: 3, slots: ['weapon', 'ring', 'amulet'] },
  dmgVsDark: { name: '對暗屬性敵人傷害%', base: 0.8, growthBase: 0.8, lv: 0.005, pct: true, weight: 3, minR: 3, slots: ['weapon', 'ring', 'amulet'] },
  elemDmgFire: { name: '火屬性傷害提升%', base: 2, growthBase: 2, lv: 0.01, pct: true, weight: 3, minR: 3, slots: ['weapon', 'belt', 'gloves', 'wrist', 'ring', 'amulet'] },
  elemDmgIce: { name: '冰屬性傷害提升%', base: 2, growthBase: 2, lv: 0.01, pct: true, weight: 3, minR: 3, slots: ['weapon', 'belt', 'gloves', 'wrist', 'ring', 'amulet'] },
  elemDmgLightning: { name: '雷屬性傷害提升%', base: 2, growthBase: 2, lv: 0.01, pct: true, weight: 3, minR: 3, slots: ['weapon', 'belt', 'gloves', 'wrist', 'ring', 'amulet'] },
  elemDmgPoison: { name: '毒屬性傷害提升%', base: 2, growthBase: 2, lv: 0.01, pct: true, weight: 3, minR: 3, slots: ['weapon', 'belt', 'gloves', 'wrist', 'ring', 'amulet'] },
  elemDmgLight: { name: '聖屬性傷害提升%', base: 2, growthBase: 2, lv: 0.01, pct: true, weight: 3, minR: 3, slots: ['weapon', 'belt', 'gloves', 'wrist', 'ring', 'amulet'] },
  elemDmgDark: { name: '暗屬性傷害提升%', base: 2, growthBase: 2, lv: 0.01, pct: true, weight: 3, minR: 3, slots: ['weapon', 'belt', 'gloves', 'wrist', 'ring', 'amulet'] },
  aoeDmg: { name: '範圍傷害%', base: 4, growthBase: 4, lv: 0.02, pct: true, weight: 4, minR: 4, slots: ['weapon', 'amulet'] },
  blockRate: { name: '格擋率%', base: 2.5, growthBase: 2.5, lv: 0.012, pct: true, weight: 4, slots: ['weapon', 'shoulder', 'chest', 'gloves', 'wrist', 'legs', 'amulet'] },
  ...
  shieldEff: { name: '護盾效率%', base: 5, growthBase: 5, lv: 0.025, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  pRes: { name: '物理抗性%', base: 10, growthBase: 10, lv: 0.04, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  mRes: { name: '魔法抗性%', base: 10, growthBase: 10, lv: 0.04, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resFire: { name: '火焰抗性%', base: 12, growthBase: 12, lv: 0.06, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resIce: { name: '冰霜抗性%', base: 12, growthBase: 12, lv: 0.06, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resLightning: { name: '雷電抗性%', base: 12, growthBase: 12, lv: 0.06, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resPoison: { name: '劇毒抗性%', base: 12, growthBase: 12, lv: 0.06, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resLight: { name: '聖光抗性%', base: 12, growthBase: 12, lv: 0.06, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resDark: { name: '暗影抗性%', base: 12, growthBase: 12, lv: 0.06, pct: true, weight: 3, minR: 3, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  resAll: { name: '全屬性抗性%', base: 4, growthBase: 4, lv: 0.02, pct: true, weight: 3, minR: 4, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  ccRed: { name: '控制時間縮減%', base: 4, growthBase: 4, lv: 0.02, pct: true, weight: 3, minR: 4, slots: ['helmet', 'shoulder', 'chest', 'belt', 'gloves', 'wrist', 'legs', 'boots', 'ring', 'amulet'] },
  moveSpeed: { name: '移動速度%', base: 3, growthBase: 3, lv: 0.012, pct: true, weight: 4, slots: ['all_lock'] },
  loot: { name: '掉寶率%', base: 3, growthBase: 3, lv: 0.015, pct: true, weight: 4, minR: 4, slots: ['ring', 'amulet'] },
  xpBonus: { name: '經驗加成%', base: 4, growthBase: 4, lv: 0.02, pct: true, weight: 4, minR: 4, slots: ['ring', 'amulet'] },
  goldBonus: { name: '金幣加成%', base: 5, growthBase: 5, lv: 0.025, pct: true, weight: 4, minR: 4, slots: ['ring', 'amulet'] },
  ...
  enhanceSuccess: { name: '強化成功率%', base: 3, growthBase: 3, lv: 0.015, pct: true, weight: 3, minR: 4, slots: ['ring', 'amulet'] },
  ...
  gemEff: { name: '寶石鑲嵌效率%', base: 5, growthBase: 5, lv: 0.025, pct: true, weight: 2, minR: 4, slots: ['ring', 'amulet'] }
};
