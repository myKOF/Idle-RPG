...
function sgGaleThunderFlash(cfg, ult, sequence, ctx) {
  ...
  var back = bfMeterPx(sgUltVal(ult, 'back'));
  var origin = { x: home.x - Math.cos(angle) * back, y: home.y - Math.sin(angle) * back };
