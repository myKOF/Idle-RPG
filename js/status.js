...
var STATUS = {
  ...
  sgStorm: { name: '暴風化身', icon: '🌪️', kind: 'buff', effect: 'stat', key: 'sgStorm', elem: '', dmgSource: '', dmg: 0, capStat: '', capMult: 0, val: 0, dur: 3, interval: 0, stack: 'refresh', maxStacks: 1, desc: '新版技能【暴風之舞】：化身暴風，期間自動施放雙刀亂舞、無法普攻。', vfx: { aura: 'ground-cyclone-avatar' } },
