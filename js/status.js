...
var STATUS = {
  ...
  sgWindRend: { name: '風切', icon: '💨', kind: 'debuff', effect: 'stat', key: 'sgWindRend', elem: 'wind', dmgSource: '', dmg: 0, capStat: '', capMult: 0, val: 80, dur: 4, interval: 0, stack: 'stack', maxStacks: 3, desc: '新版技能【風切狀態】的減益本體：移動速度下降（效果值＝單層下降%，不隨層數再加深）且命中率下降；層數只影響風切割裂的每跳傷害，當下允許的層數上限由真空斬【無限風切】決定。' },
