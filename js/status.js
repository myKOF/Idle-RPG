...
var STATUS = {
  ...
  sgFrostBite: { name: '寒霜凍傷', icon: '🧊', kind: 'debuff', effect: 'dot', key: '', elem: 'ice', dmgSource: 'skill', dmg: 50, capStat: '', capMult: 0, val: 0, dur: 5, interval: 0.5, stack: 'strongest', maxStacks: 1, desc: '新版技能【寒霜狀態】的寒冰持續傷害；每跳量＝施放群組本體傷害 B × 寒霜共用倍率 ×（50×目前寒霜總層數＋該來源寒霜階每級增量×該階等級）%，總層數包含所有技能來源（引擎以 dps 覆寫）。' },
