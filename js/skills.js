...
var SKILLS = {
  ...
  meteor: { name: '隕石術', emoji: '☄️', cat: 'magic', tags: ['fire'], unlockLv: 50, cost: 60, cd: 25, shape: '4*4', flavor: '呼喚天降隕石毀滅一切。', fx: { dmgType: 'magic', stat: 'matk', base: 1260, per: 255 } },
...
function castSkill(pEnt, target, id, lv, floatSel, statSlot, opts) {
  ...
  if (fx.dmgType) {
    ...
    if (totalDmg > 0) {
      ...
      // 屬性吸血／吸魔已隨每次實際傷害結算，不在整次施放結束時重複回復。
