...
var SKILLS = {
  powerSlash: { name: '強力斬', emoji: '🗡️', cat: 'phys', tags: [], unlockLv: 1, cost: 15, cd: 6, flavor: '蓄力揮出沉重的一擊。', fx: { dmgType: 'phys', stat: 'atk', base: 360, per: 80 }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  doubleStrike: { name: '二連擊', emoji: '⚔️', cat: 'phys', tags: [], unlockLv: 1, cost: 20, cd: 8, flavor: '快速的兩段斬擊。', fx: { dmgType: 'phys', stat: 'atk', base: 210, per: 44, hits: 2 }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  whirlwind: { name: '旋風斬', emoji: '🌪️', cat: 'phys', tags: [], unlockLv: 1, cost: 25, cd: 10, shape: '3*3', flavor: '旋轉身軀橫掃周遭。', fx: { dmgType: 'phys', stat: 'atk', base: 505, per: 110 }, vfx: { attack: 'burst-cyclone-phys', hit: 'hit-phys' } },
  armorBreak: { name: '破甲擊', emoji: '🔨', cat: 'phys', tags: [], unlockLv: 1, cost: 20, cd: 12, flavor: '重擊敵人的護甲弱點。', fx: { dmgType: 'phys', stat: 'atk', base: 300, per: 60, status: [{ id: 'penUp', base: 25, per: 5, dur: 5 }] }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  executeStrike: { name: '處決', emoji: '💀', cat: 'phys', tags: [], unlockLv: 20, cost: 30, cd: 15, flavor: '對瀕死敵人給予終結。', fx: { dmgType: 'phys', stat: 'atk', base: 500, per: 110, execBelow: 30, execMult: 2 }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  rendWound: { name: '撕裂', emoji: '🩸', cat: 'phys', tags: [], unlockLv: 20, cost: 18, cd: 10, flavor: '造成難以癒合的傷口。', fx: { dmgType: 'phys', stat: 'atk', base: 240, per: 50, status: [{ id: 'bleed', base: 25, dur: 5 }] }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  stunBlow: { name: '震盪重擊', emoji: '💫', cat: 'phys', tags: [], unlockLv: 20, cost: 25, cd: 14, flavor: '猛擊敵人使其暈眩。', fx: { dmgType: 'phys', stat: 'atk', base: 320, per: 65, status: [{ id: 'stun', dur: 1.5 }] }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  berserkStrike: { name: '狂暴打擊', emoji: '😤', cat: 'phys', tags: [], unlockLv: 20, cost: 20, cd: 12, flavor: '不顧自身安危的猛攻。', fx: { dmgType: 'phys', stat: 'atk', base: 840, per: 170, selfDmgPct: 5 }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  preciseThrust: { name: '精準突刺', emoji: '🎯', cat: 'phys', tags: [], unlockLv: 50, cost: 15, cd: 8, flavor: '絕不落空的致命突刺。', fx: { dmgType: 'phys', stat: 'atk', base: 300, per: 65, neverMiss: true, critBonus: 30 }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  heavySmash: { name: '泰山壓頂', emoji: '🪨', cat: 'phys', tags: [], unlockLv: 50, cost: 28, cd: 13, flavor: '沉重的壓制性打擊。', fx: { dmgType: 'phys', stat: 'atk', base: 600, per: 130, status: [{ id: 'slow', dur: 3 }] }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  swiftCuts: { name: '疾風連斬', emoji: '🍃', cat: 'phys', tags: [], unlockLv: 50, cost: 32, cd: 16, shape: '3*3', flavor: '化作疾風的三段斬。', fx: { dmgType: 'phys', stat: 'atk', base: 165, per: 35, hits: 3 }, vfx: { attack: 'slash-phys-big', hit: 'hit-phys' } },
  counterStance: { name: '反擊架勢', emoji: '🔄', cat: 'phys', tags: [], unlockLv: 100, cost: 22, cd: 18, flavor: '擺出以牙還牙的架勢。', fx: { status: [{ id: 'thornsUp', base: 12, per: 4, dur: 6 }] }, vfx: { cast: 'cast-buff-phys' } },
  soulBrandFlurry: { name: '烙魂連斬', emoji: '🪓', cat: 'phys', tags: [], unlockLv: 100, cost: 28, cd: 12, flavor: '三連斬光落下，將敵人的魂魄烙上戰印。', fx: { dmgType: 'phys', stat: 'atk', base: 145, per: 32, hits: 3, brand: { name: '魂痕', storePct: 30, dur: 8, maxStacks: 3 } }, vfx: { attack: 'slash-phys', hit: 'hit-phys' } },
  sinDetonate: { name: '斷罪引爆', emoji: '🧨', cat: 'phys', tags: [], unlockLv: 100, cost: 36, cd: 16, flavor: '一擊定罪，引爆所有烙印的宿命。', fx: { dmgType: 'phys', stat: 'atk', base: 560, per: 110, detonate: { brand: 'any', multPct: { base: 120, per: 3 }, resetCd: { id: 'soulBrandFlurry', pct: 25 } } }, vfx: { attack: 'burst-detonate-phys', hit: 'hit-phys' } },
  echoBlade: { name: '殘影迴斬', emoji: '🌒', cat: 'phys', tags: [], unlockLv: 150, cost: 32, cd: 15, shape: '2*2', flavor: '斬擊的殘影在剎那之後追上真實。', fx: { dmgType: 'phys', stat: 'atk', base: 520, per: 100, dmgWindow: { dur: 2, pct: 35 } }, vfx: { attack: 'slash-phys-big', hit: 'hit-phys' } },
  warSpiritEngine: { name: '鬥氣輪轉', emoji: '🥊', cat: 'phys', tags: [], unlockLv: 150, cost: 12, cd: 5, flavor: '鬥氣隨戰意輪轉，蓄滿之刻便是爆發之時。', fx: { charge: { name: '鬥氣', add: 1, max: 3, dur: 15, source: 'attackHit', burst: { multPct: { base: 120, per: 5 }, scope: 'next' } } }, vfx: { cast: 'cast-buff-phys' } },
  pursuitDecree: { name: '追擊號令', emoji: '📯', cat: 'phys', tags: [], unlockLv: 150, cost: 18, cd: 14, flavor: '號令一出，萬刃爭先。', fx: { cdShift: { scope: 'cat:phys', sec: { base: 1.5, per: 0.1 } } }, vfx: { cast: 'cast-buff-phys' } },
  warOverture: { name: '破軍先聲', emoji: '⚜️', cat: 'phys', tags: [], unlockLv: 200, cost: 22, cd: 16, flavor: '先聲奪人，為最沉重的一擊鋪路。', fx: { skillAmp: { scope: 'next', dur: 8, uses: 1, perCdSec: { base: 4, per: 0.1 }, cap: 120 } }, vfx: { cast: 'cast-buff-phys' } },
  woundCollapse: { name: '萬創崩裂', emoji: '💔', cat: 'phys', tags: [], unlockLv: 200, cost: 20, cd: 12, flavor: '讓所有傷口在同一瞬間崩裂。', fx: { dotPulse: { ticks: 2, powerPct: { base: 100, per: 3 } }, requiresTargetDot: true }, vfx: { attack: 'curse-bleed', hit: 'hit-phys' } },
  mindflowChain: { name: '連環戰訣', emoji: '🔗', cat: 'phys', tags: [], unlockLv: 300, cost: 10, cd: 15, flavor: '招式相連，戰意不絕。', fx: { comboWindow: { dur: 3, pct: { base: 25, per: 1 } } }, vfx: { cast: 'cast-buff-phys' } },
  swordDomain: { name: '劍域千鋒', emoji: '🗡️', cat: 'phys', tags: [], unlockLv: 300, cost: 30, cd: 18, flavor: '千鋒出鞘，方圓皆為劍之領域。', fx: { dmgType: 'phys', stat: 'atk', base: 220, per: 45, field: { name: '劍域', dur: 6, tickSec: 1, tickPct: 25 } }, vfx: { attack: 'slash-phys-big', hit: 'hit-phys', ground: 'ground-swordfield' } },
  arcaneBurst: { name: '奧術衝擊', emoji: '🌠', cat: 'magic', tags: ['light'], unlockLv: 1, cost: 30, cd: 10, flavor: '釋放純粹的奧術能量。', fx: { dmgType: 'magic', stat: 'matk', base: 330, per: 75 }, vfx: { cast: 'cast-magic', projectile: 'proj-light-orb', hit: 'hit-light' } },
  fireball: { name: '火球術', emoji: '🔥', cat: 'magic', tags: ['fire'], unlockLv: 1, cost: 25, cd: 9, flavor: '投出灼熱的火球並點燃敵人。', fx: { dmgType: 'magic', stat: 'matk', base: 360, per: 80, status: [{ id: 'burn', base: 20, dur: 4 }] }, vfx: { cast: 'cast-magic', projectile: 'proj-fireball', hit: 'hit-fire' } },
  iceLance: { name: '寒冰槍', emoji: '❄️', cat: 'magic', tags: ['ice'], unlockLv: 1, cost: 25, cd: 9, shape: '1*3', flavor: '冰冷的長槍刺穿敵人。', fx: { dmgType: 'magic', stat: 'matk', base: 330, per: 70, status: [{ id: 'slow', dur: 3 }] }, vfx: { attack: 'beam-ice', hit: 'hit-ice' } },
  chainLightning: { name: '連鎖閃電', emoji: '⚡', cat: 'magic', tags: ['lightning'], unlockLv: 1, cost: 28, cd: 11, flavor: '躍動的閃電連續劈落。', fx: { dmgType: 'magic', stat: 'matk', base: 190, per: 40, hits: 2 }, vfx: { cast: 'cast-magic', attack: 'bolt-sky-lightning', projectile: 'bolt-chain-lightning', hit: 'hit-lightning' } },
  venomCloud: { name: '劇毒雲霧', emoji: '☠️', cat: 'magic', tags: ['poison'], unlockLv: 20, cost: 26, cd: 12, flavor: '瀰漫的毒霧侵蝕敵人。', fx: { dmgType: 'magic', stat: 'matk', base: 200, per: 40, status: [{ id: 'poison', base: 40, dur: 6 }] }, vfx: { cast: 'cast-magic', attack: 'burst-venom', projectile: 'proj-poison-drop', hit: 'hit-poison' } },
  holySmite: { name: '聖光審判', emoji: '🌟', cat: 'magic', tags: ['light'], unlockLv: 20, cost: 25, cd: 10, flavor: '聖光降下裁決並潔淨己身。', fx: { dmgType: 'magic', stat: 'matk', base: 340, per: 70, selfCleanse: true }, vfx: { attack: 'pillar-light', hit: 'hit-light' } },
  shadowBolt: { name: '暗影箭', emoji: '🌑', cat: 'magic', tags: ['dark'], unlockLv: 20, cost: 25, cd: 10, flavor: '汲取生命的暗影之矢。', fx: { dmgType: 'magic', stat: 'matk', base: 320, per: 70, healPctOfDmg: 30 }, vfx: { cast: 'cast-drain', projectile: 'proj-dark-orb', hit: 'hit-dark' } },
  arcaneBarrage: { name: '奧術彈幕', emoji: '💫', cat: 'magic', tags: ['light'], unlockLv: 20, cost: 40, cd: 15, flavor: '傾瀉四發奧術飛彈。', fx: { dmgType: 'magic', stat: 'matk', base: 135, per: 30, hits: 4 }, vfx: { cast: 'cast-magic', projectile: 'proj-arcane-missile', hit: 'hit-light' } },
  meteor: { name: '隕石術', emoji: '☄️', cat: 'magic', tags: ['fire'], unlockLv: 50, cost: 60, cd: 25, shape: '4*4', flavor: '呼喚天降隕石毀滅一切。', fx: { dmgType: 'magic', stat: 'matk', base: 1260, per: 255 }, vfx: { attack: 'burst-fire-shockwave', projectile: 'proj-meteor', hit: 'hit-fire-explosion', ground: 'mark-red' } },
  manaBurn: { name: '法力灼燒', emoji: '🔮', cat: 'magic', tags: ['light'], unlockLv: 50, cost: 20, cd: 8, flavor: '以法力引發劇烈爆燃，爆擊時返還法力。', fx: { dmgType: 'magic', stat: 'matk', base: 320, per: 70, mpOnCrit: 20 }, vfx: { cast: 'cast-magic', projectile: 'proj-light-orb', hit: 'hit-light' } },
  frostNova: { name: '霜之新星', emoji: '🧊', cat: 'magic', tags: ['ice'], unlockLv: 50, cost: 30, cd: 14, flavor: '迸發的冰環凍結敵人。', fx: { dmgType: 'magic', stat: 'matk', base: 260, per: 55, status: [{ id: 'stun', dur: 1 }] }, vfx: { cast: 'cast-magic', attack: 'burst-frost-nova', projectile: 'proj-ice-shard', hit: 'hit-ice' } },
  voidRift: { name: '虛空裂隙', emoji: '🕳️', cat: 'magic', tags: ['dark'], unlockLv: 100, cost: 45, cd: 18, flavor: '撕開無視一切防禦的虛空。', fx: { dmgType: 'true', stat: 'matk', base: 325, per: 70 }, vfx: { cast: 'cast-magic', attack: 'burst-detonate-dark', projectile: 'proj-dark-orb', hit: 'hit-dark' } },
  stormSigil: { name: '雷紋刻印', emoji: '⛈️', cat: 'magic', tags: ['lightning'], unlockLv: 100, cost: 24, cd: 9, flavor: '雷紋入體，蓄勢待鳴。', fx: { dmgType: 'magic', stat: 'matk', base: 260, per: 55, brand: { name: '雷印', storePct: 35, dur: 8, maxStacks: 1 } }, vfx: { attack: 'bolt-sky-purple', hit: 'hit-thunder-purple' } },
  runeShatter: { name: '碎印湮滅', emoji: '💥', cat: 'magic', tags: ['dark'], unlockLv: 100, cost: 30, cd: 12, flavor: '碎印之刻，湮滅隨行。', fx: { dmgType: 'magic', stat: 'matk', base: 300, per: 65, detonate: { brand: 'any', multPct: { base: 150, per: 3 }, chainPct: 60 } }, vfx: { cast: 'cast-magic', attack: 'burst-detonate-dark', projectile: 'proj-dark-orb', hit: 'hit-dark' } },
  emberEcho: { name: '燼焰回響', emoji: '🎆', cat: 'magic', tags: ['fire'], unlockLv: 150, cost: 32, cd: 13, shape: '3*3', flavor: '燼焰未熄，烈火再臨。', fx: { dmgType: 'magic', stat: 'matk', base: 330, per: 70, echo: { delay: 2, powerPct: 40, repeat: 1 } }, vfx: { attack: 'burst-fire', hit: 'hit-fire' } },
  infernoDomain: { name: '焚世領域', emoji: '🌋', cat: 'magic', tags: ['fire'], unlockLv: 150, cost: 45, cd: 20, flavor: '焚世之火，燎盡八荒。', fx: { dmgType: 'magic', stat: 'matk', base: 240, per: 50, field: { name: '焚世領域', dur: 6, tickSec: 1, tickPct: 25, elem: 'fire', takenAmpPct: 15 } }, vfx: { cast: 'cast-magic', projectile: 'proj-fireball', hit: 'hit-fire', ground: 'ground-field-fire' } },
  plagueBurst: { name: '疫爆術', emoji: '🦠', cat: 'magic', tags: ['poison'], unlockLv: 150, cost: 28, cd: 14, flavor: '讓蔓延的疫病在一瞬間齊聲炸裂。', fx: { dmgType: 'magic', stat: 'matk', base: 200, per: 42, dotDetonate: { pct: { base: 80, per: 1 }, cap: 100 }, requiresTargetDot: true, status: [{ id: 'plague', base: 40, dur: 6 }] }, vfx: { cast: 'cast-magic', attack: 'burst-venom', projectile: 'proj-poison-drop', hit: 'hit-poison' } },
  frostResonance: { name: '霜晶共鳴', emoji: '🌨️', cat: 'magic', tags: ['ice'], unlockLv: 200, cost: 22, cd: 8, flavor: '霜晶共鳴，凜冬將至。', fx: { dmgType: 'magic', stat: 'matk', base: 240, per: 50, charge: { name: '霜晶', add: 1, max: 4, dur: 20, source: 'cast', burst: { multPct: 180, scope: 'self' } } }, vfx: { cast: 'cast-magic', projectile: 'proj-ice-shard', hit: 'hit-ice' } },
  astralConduit: { name: '星辰引導', emoji: '🔯', cat: 'magic', tags: ['light'], unlockLv: 200, cost: 20, cd: 15, flavor: '引導星辰之力，注入下一式。', fx: { skillAmp: { scope: 'next', pct: { base: 30, per: 3 }, dur: 8, uses: 1, refundPct: 40 } }, vfx: { cast: 'cast-buff-light' } },
  bloodSurge: { name: '瀝血狂濤', emoji: '🩸', cat: 'magic', tags: ['dark'], unlockLv: 300, cost: 25, cd: 16, flavor: '以血為潮，掀起狂濤。', fx: { dmgType: 'magic', stat: 'matk', base: 300, per: 65, hpSacrifice: { hpPct: 15, ampPct: { base: 80, per: 2 } } }, vfx: { cast: 'cast-magic', projectile: 'proj-dark-orb', hit: 'hit-dark' } },
  rimeTide: { name: '凜冬迴潮', emoji: '🌬️', cat: 'magic', tags: ['ice'], unlockLv: 300, cost: 26, cd: 12, flavor: '凜冬迴潮，捲回流逝的時間。', fx: { dmgType: 'magic', stat: 'matk', base: 260, per: 55, cdShift: { sec: { base: 1.5, per: 0.1 } } }, vfx: { cast: 'cast-magic', projectile: 'proj-ice-shard', hit: 'hit-ice' } },
  healWound: { name: '治癒術', emoji: '💚', cat: 'def', tags: [], unlockLv: 1, cost: 30, cd: 12, ai: 'hurt70', flavor: '溫暖的光輝癒合傷口。', fx: { healPctMax: { base: 15, per: 4 } }, vfx: { cast: 'cast-buff-def' } },
  regenerate: { name: '再生術', emoji: '🌿', cat: 'def', tags: [], unlockLv: 1, cost: 28, cd: 15, ai: 'hurt80', flavor: '持續再生的自然之力。', fx: { status: [{ id: 'regen', base: 2.5, per: 0.7, dur: 6 }] }, vfx: { cast: 'cast-buff-def' } },
  manaBarrier: { name: '魔法屏障', emoji: '🛡️', cat: 'def', tags: [], unlockLv: 1, cost: 30, cd: 15, ai: 'shield', flavor: '展開吸收傷害的屏障。', fx: { status: [{ id: 'shield', base: 18, per: 4 }] }, vfx: { cast: 'cast-buff-def' } },
  ironWall: { name: '鐵壁', emoji: '🏰', cat: 'def', tags: [], unlockLv: 1, cost: 25, cd: 18, ai: 'hurt50', flavor: '硬化全身抵禦攻擊。', fx: { status: [{ id: 'defUp', base: 40, per: 10, dur: 6 }] }, vfx: { cast: 'cast-buff-def' } },
  purify: { name: '淨化術', emoji: '✨', cat: 'def', tags: [], unlockLv: 20, cost: 15, cd: 10, ai: 'debuffed', flavor: '洗去身上的負面狀態。', fx: { selfCleanse: true, healPctMax: { base: 5, per: 1.5 } }, vfx: { cast: 'cast-buff-def' } },
  lifeLink: { name: '生命汲取', emoji: '🧛', cat: 'def', tags: ['dark'], unlockLv: 20, cost: 22, cd: 10, flavor: '奪取敵人的生命力。', fx: { dmgType: 'magic', stat: 'matk', base: 220, per: 50, healPctOfDmg: 100 }, vfx: { cast: 'cast-drain', projectile: 'proj-dark-orb', hit: 'hit-dark' } },
  sanctuary: { name: '庇護所', emoji: '⛪', cat: 'def', tags: [], unlockLv: 20, cost: 30, cd: 20, ai: 'hurt40', flavor: '神聖領域護佑己身。', fx: { status: [{ id: 'evasionUp', base: 25, per: 5, dur: 5 }] }, vfx: { cast: 'cast-buff-def' } },
  secondWind: { name: '回春氣息', emoji: '💨', cat: 'def', tags: [], unlockLv: 20, cost: 0, cd: 25, ai: 'hurt30', flavor: '危急時的求生本能（不耗魔）。', fx: { healPctMax: { base: 10, per: 3 }, mpRestore: 20 }, vfx: { cast: 'cast-buff-def' } },
  reflectShield: { name: '反射護盾', emoji: '🪞', cat: 'def', tags: [], unlockLv: 50, cost: 28, cd: 18, flavor: '反彈傷害的光盾。', fx: { status: [{ id: 'thornsUp', base: 15, per: 5, dur: 6 }, { id: 'blockUp', base: 12, per: 4, dur: 6 }] }, vfx: { cast: 'cast-buff-def' } },
  lastStand: { name: '背水一戰', emoji: '🚩', cat: 'def', tags: [], unlockLv: 50, cost: 35, cd: 30, ai: 'hurt25', flavor: '絕境中爆發的鬥志。', fx: { healPctMax: { base: 20, per: 5 }, status: [{ id: 'atkUp', base: 15, per: 5, dur: 6 }] }, vfx: { cast: 'cast-buff-def' } },
  aegisBurst: { name: '聖盾崩華', emoji: '💠', cat: 'def', tags: ['light'], unlockLv: 50, cost: 26, cd: 14, flavor: '聖盾崩華之瞬，守護化為鋒芒。', fx: { dmgType: 'magic', stat: 'matk', base: 180, per: 40, shieldBurst: { convertPct: 60, capAtkMult: 10 } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  overflowVerdict: { name: '溢流聖罰', emoji: '⛲', cat: 'def', tags: ['light'], unlockLv: 100, cost: 30, cd: 16, flavor: '滿溢的聖光，即是裁罰。', fx: { healPctMax: { base: 12, per: 3 }, overhealDmg: { pct: { base: 40, per: 2 }, cap: 90 } }, vfx: { cast: 'cast-buff-light' } },
  stigmaCycle: { name: '聖痕輪迴', emoji: '🪬', cat: 'def', tags: ['light'], unlockLv: 100, cost: 24, cd: 9, flavor: '承受的苦難，終將輪迴為裁決。', fx: { dmgType: 'magic', stat: 'matk', base: 200, per: 45, stigma: { storePct: 35, dur: 8, capMaxHpPct: 20, multPct: 130 } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  soulEcho: { name: '汲魂回響', emoji: '🔔', cat: 'def', tags: ['dark'], unlockLv: 100, cost: 24, cd: 12, flavor: '傷痛的回響，化作汲魂的甘露。', fx: { dmgType: 'magic', stat: 'matk', base: 200, per: 45, healPctOfDmg: 60, healEcho: { dur: 2, pct: { base: 40, per: 2 } } }, vfx: { cast: 'cast-drain', projectile: 'proj-dark-orb', hit: 'hit-dark' } },
  holyLitany: { name: '連禱聖言', emoji: '📜', cat: 'def', tags: ['light'], unlockLv: 150, cost: 20, cd: 18, flavor: '聖言連禱，為守護者開路。', fx: { healPctMax: { base: 6, per: 1.5 }, freeNext: { count: 1, dur: 6, scope: 'cat:def', ampPct: { base: 30, per: 2 } } }, vfx: { cast: 'cast-buff-light' } },
  sustainHymn: { name: '續光聖詠', emoji: '🎐', cat: 'def', tags: ['light'], unlockLv: 150, cost: 22, cd: 15, flavor: '聖詠不歇，恩澤長存。', fx: { healPctMax: { base: 5, per: 1.2 }, buffExtend: { sec: 2 } }, vfx: { cast: 'cast-buff-light' } },
  bastionCycle: { name: '壁壘迴環', emoji: '♻️', cat: 'def', tags: [], unlockLv: 150, cost: 28, cd: 20, ai: 'shield', flavor: '壁壘每一次震響，都是反攻的號角。', fx: { cdOnHitTaken: { sec: 0.4, icdSec: 0.5 }, status: [{ id: 'shield', base: 10, per: 2.5 }] }, vfx: { cast: 'cast-buff-def' } },
  martyrCharge: { name: '蓄怒之盾', emoji: '😤', cat: 'def', tags: [], unlockLv: 200, cost: 16, cd: 7, flavor: '承受吧——怒火終將百倍奉還。', fx: { dmgType: 'phys', stat: 'atk', base: 140, per: 30, charge: { name: '蓄怒', add: 1, max: 4, dur: 15, source: 'hitTaken', burst: { multPct: { base: 200, per: 6 }, scope: 'self' } } }, vfx: { projectile: 'proj-arcane-missile', hit: 'hit-phys' } },
  sanctify: { name: '聖化禱言', emoji: '🙏', cat: 'def', tags: ['light'], unlockLv: 200, cost: 25, cd: 22, flavor: '受聖化的禱言，讓守護亦能傷人。', fx: { healPctMax: { base: 8, per: 2 }, skillAmp: { scope: 'cat:def', pct: { base: 20, per: 4 }, dur: 8 } }, vfx: { cast: 'cast-buff-light' } },
  timeWarp: { name: '時間扭曲', emoji: '⏳', cat: 'special', tags: [], unlockLv: 1, cost: 35, cd: 20, flavor: '加速自身的時間流。', fx: { status: [{ id: 'aspdUp', base: 25, per: 7, dur: 6 }] }, vfx: { cast: 'cast-buff-special' } },
  midasTouch: { name: '點金手', emoji: '🪙', cat: 'special', tags: [], unlockLv: 1, cost: 25, cd: 20, flavor: '揮出將敵人化為財富的一擊。', fx: { dmgType: 'phys', stat: 'atk', base: 200, per: 40, goldPer: 15 }, vfx: { projectile: 'proj-arcane-missile', hit: 'hit-phys' } },
  treasureSense: { name: '尋寶直覺', emoji: '🔍', cat: 'special', tags: [], unlockLv: 1, cost: 30, cd: 30, flavor: '嗅出寶物的氣息。', fx: { status: [{ id: 'lootUp', base: 15, per: 5, dur: 10 }] }, vfx: { cast: 'cast-buff-special' } },
  weakenCurse: { name: '虛弱詛咒', emoji: '📉', cat: 'special', tags: ['dark'], unlockLv: 1, cost: 22, cd: 15, flavor: '削弱敵人的力量。', fx: { status: [{ id: 'atkDown', base: 18, per: 4, dur: 6 }] }, vfx: { attack: 'curse-dark', hit: 'hit-dark' } },
  deathCurse: { name: '死亡詛咒', emoji: '⚰️', cat: 'special', tags: ['dark'], unlockLv: 20, cost: 40, cd: 20, flavor: '以敵人生命為薪的詛咒。', fx: { status: [{ id: 'deathCurse', base: 2.4, per: 0.8, dur: 5 }] }, vfx: { attack: 'curse-dark', hit: 'hit-dark' } },
  blinkDodge: { name: '瞬身', emoji: '🌀', cat: 'special', tags: [], unlockLv: 20, cost: 20, cd: 16, flavor: '殘影閃避致命攻擊。', fx: { status: [{ id: 'evasionUp', base: 35, per: 7, dur: 3 }] }, vfx: { cast: 'cast-buff-special' } },
  mpSiphon: { name: '法力虹吸', emoji: '🌊', cat: 'special', tags: ['light'], unlockLv: 20, cost: 0, cd: 12, flavor: '從敵人身上抽取法力（不耗魔）。', fx: { dmgType: 'magic', stat: 'matk', base: 160, per: 30, mpRestore: 25 }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  overload: { name: '超載', emoji: '💥', cat: 'special', tags: [], unlockLv: 20, cost: 30, cd: 22, flavor: '讓每次爆擊更加致命。', fx: { status: [{ id: 'critDmgUp', base: 40, per: 12, dur: 6 }] }, vfx: { cast: 'cast-buff-special' } },
  warcry: { name: '戰吼', emoji: '📣', cat: 'special', tags: [], unlockLv: 50, cost: 25, cd: 18, flavor: '震天的吼聲鼓舞自己、震懾敵人。', fx: { status: [{ id: 'atkUp', base: 12, per: 4, dur: 6 }, { id: 'atkDown', base: 8, per: 2, dur: 6 }] }, vfx: { cast: 'cast-buff-special' } },
  gamble: { name: '孤注一擲', emoji: '🎲', cat: 'special', tags: [], unlockLv: 50, cost: 30, cd: 15, flavor: '傷害在 50%~250% 之間隨機。', fx: { dmgType: 'phys', stat: 'atk', base: 375, per: 85, gamble: true }, vfx: { projectile: 'proj-arcane-missile', hit: 'hit-phys' } },
  fateRoulette: { name: '命運輪盤', emoji: '🎰', cat: 'special', tags: ['light'], unlockLv: 50, cost: 35, cd: 18, flavor: '命運的輪盤，永遠轉向出乎意料的一格。', fx: { dmgType: 'magic', stat: 'matk', base: 180, per: 35, proc: { on: 'hit', pct: 100, do: 'castRandom', powerPct: { base: 50, per: 2 } } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  bestReplay: { name: '昔日重演', emoji: '📽️', cat: 'special', tags: ['light'], unlockLv: 100, cost: 30, cd: 14, flavor: '昔日的輝煌，此刻重演。', fx: { dmgType: 'magic', stat: 'matk', base: 300, per: 60, replayBest: { powerPct: { base: 40, per: 2 }, window: 6, repeat: 1 } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  chronoPilfer: { name: '竊時者', emoji: '🕰️', cat: 'special', tags: ['light'], unlockLv: 100, cost: 25, cd: 20, flavor: '竊走的每一秒，都屬於最漫長的等待。', fx: { dmgType: 'magic', stat: 'matk', base: 200, per: 40, cdShift: { sec: { base: 3, per: 0.2 }, focus: 'longest' } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  gamblerChips: { name: '賭徒籌碼', emoji: '🃏', cat: 'special', tags: [], unlockLv: 100, cost: 20, cd: 8, flavor: '籌碼疊滿之時，就是梭哈之刻。', fx: { dmgType: 'phys', stat: 'atk', base: 150, per: 30, charge: { name: '籌碼', addRange: [1, 3], max: 5, dur: 15, source: 'cast', burst: { multPct: { base: 150, per: 4 }, scope: 'next' } } }, vfx: { projectile: 'proj-arcane-missile', hit: 'hit-phys' } },
  omniBrand: { name: '萬象烙印', emoji: '🔱', cat: 'special', tags: ['light'], unlockLv: 150, cost: 30, cd: 12, flavor: '萬象歸一印，一印破萬象。', fx: { dmgType: 'magic', stat: 'matk', base: 220, per: 45, detonate: { brand: 'any', multPct: { base: 200, per: 5 } }, brand: { name: '萬象印', storePct: 35, dur: 10, maxStacks: 1 } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  arcaneAllIn: { name: '奧能梭哈', emoji: '🎇', cat: 'special', tags: ['light'], unlockLv: 150, cost: 0, cd: 25, flavor: '傾盡所有法力，換一擊無悔（不耗魔）。', fx: { dmgType: 'magic', stat: 'matk', base: 250, per: 50, mpDump: { pctPer10Mp: { base: 2, per: 0.15 } } }, vfx: { projectile: 'proj-light-orb', hit: 'hit-light' } },
  flowSurge: { name: '心流湧動', emoji: '🧘', cat: 'special', tags: [], unlockLv: 150, cost: 30, cd: 22, flavor: '心流湧動之間，施法再無滯礙。', fx: { freeNext: { count: 2, dur: { base: 5, per: 0.3 } } }, vfx: { cast: 'cast-buff-special' } },
  comboResonance: { name: '連段共鳴', emoji: '🎶', cat: 'special', tags: [], unlockLv: 200, cost: 25, cd: 15, flavor: '連段共鳴，段段生威。', fx: { skillAmp: { scope: 'multiHit', pct: { base: 35, per: 4 }, dur: 10 } }, vfx: { cast: 'cast-buff-special' } },
  chronoAnchor: { name: '時之錨', emoji: '⚓', cat: 'special', tags: [], unlockLv: 200, cost: 20, cd: 16, flavor: '拋下時之錨，讓美好的瞬間多留一會。', fx: { buffExtend: { sec: { base: 1.5, per: 0.15 } } }, vfx: { cast: 'cast-buff-special' } },
