...
test('追蹤風刃不建立綠色方框，且舊事件不會以座標重建跳格節點', () => {
  ...
  assert.match(index, /js\/battle-renderer\.js\?v=1\.6\.104/);
  assert.match(index, /js\/skills2\.js\?v=1\.0\.79/);
  assert.match(bridge, /WORKER_ASSET_VERSION = '20260826-firegod-ring'/);
  assert.match(worker, /\.\.\/skills\.js\?v=20260825-mire-earthguard-legendary/);
  assert.match(worker, /\.\.\/skills2\.js\?v=20260826-firegod-ring/);
