...
function make(){
 ...
 p.id='proj-meteor-inferno';p.sizing={shape:'projectile-circle',authored:{radius:55}};
...
p.layers.push(sprite({id:'cracked-meteor-core',asset:'new_materials/orb/sphere_23.png',size:85,tint:'#ff7a1a',alpha:0.95,blend:'add'}));
p.layers.push(sprite({id:'inferno-meteor-core-ring',asset:k.alphaTwin(A.ringThin),size:140,tint:'#ffb347',alpha:.45,blend:'add',duration:1,alphaOverLife:[[0,.45],[.2,.6],[1,.2]]}));
