...
function make(){
 ...
 for(let i=0;i<2;i++){const l=add('floor-spiral-'+i,k.A.twirl03,{x:0,y:0},{x:.7-i*.1,y:.7-i*.1},i?'#82ffdb':'#409eea',i?.65:.75,i);l.outerScale={x:1,y:.38};l.rotation=i*Math.PI;l.rotationOverLife=[[0,0],[1,-Math.PI*2]];}
