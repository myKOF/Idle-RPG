...
const p={schemaVersion:1,id:'burst-vacuum-shockwave',duration:.6,loop:false,sizing:{shape:'circle',radiusM:10,authored:{radius:150}},layers:[]};
for(const original of source.layers.filter(l=>l.type==='sprite')){
 ...
 l.startScale=l.scale.x;delete l.scale;delete l.rotationOverLife;
 l.alpha=(l.alpha===undefined?1:l.alpha)*.55;
 l.scaleOverLife=[[0,.85],[.5,1.12],[1,1.4]];
