...
edits.push({ file: 'formula', re: /aspd: (-?[\d.]+),\s*\n\s*dodge: 0,/, grp: 1, value: P('4-野外怪物', '攻擊速度', 0), label: 'mob-aspd' });
...
edits.push({ file: 'formula', re: /(dodge: Math\.min\([\d.]+ \+ floor \* )([\d.]+)/, grp: 2, value: P('4-高塔BOSS', '閃避', 2), label: 'boss閃避加乘' });
edits.push({ file: 'formula', re: /(dodge: Math\.min\([\d.]+ \+ floor \* [\d.]+, )([\d.]+)/, grp: 2, value: P('4-高塔BOSS', '閃避', 1), label: 'boss閃避上' });
