...
## 戰鬥界面優化：狀態圖示改為正方形圖標、靠左對齊、圓形倒計時遮罩、右下角疊層與 Tooltip 效果提示（Antigravity 2026-08-16）
...
- **右下角疊層數字與 Tooltip 提示**：
  ...
  - 狀態名稱、詳細效果描述、吸收量/屬性數值與剩餘秒數統一由 Tooltip 浮動提示（Tips）展示，支援懸停即時動態刷新。
- **測試與建置驗證**：
  - 更新 `tests/active-buffs-panel.test.cjs` 驗證正方形尺寸、靠左對齊、倒計時遮罩、右下角疊層與 Tooltip。
