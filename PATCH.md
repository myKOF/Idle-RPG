...
## 300 級怪物高血量單波實測（打到死為止）全 8 大技能群組基準重測（Antigravity 2026-08-21）

- **測試設定調整**：
  - 依使用者指示調整為 **300 級怪物（沼澤 Swamp Stage 300）**，血量達千億至兆級（小怪 ~1,776 億、菁英 ~7,105 億、BOSS ~2.66 兆），徹底杜絕秒殺與除數極端誤差，溢出傷害佔比低於 1%。
  - **單波出怪（1 波打到死為止）**：小怪 20 隻/波、菁英 5 隻/波、BOSS 1 隻/波，全部由戰場外圍生成逼近，不再分 10 波出怪，打到全滅為止。
