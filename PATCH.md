...
## 戰鬥界面優化：狀態圖示改為正方形圖標、靠左對齊、圓形倒計時遮罩、右下角疊層與 Tips 右上角即時倒計時（Antigravity 2026-08-16）
...
- **測試與建置驗證**：
  - 更新 `tests/active-buffs-panel.test.cjs` 驗證正方形尺寸、靠左對齊、倒計時遮罩、右下角疊層與 Tips 右上角即時倒計時。
